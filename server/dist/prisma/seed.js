    ...
    await prisma.project.createMany({
        data: [{
            ...
            },
            {
                ...
                tech_stack: ['React', 'Sqlite3', 'Express', 'Typescript', 'Tailwind', 'Knex', 'Auth0', 'Superagent', 'Vite', 'Vitest', 'Nock', 'React Testing Library'],
                url: '',
                github: 'https://github.com/Daisychoi1995/GearedUp',
                image_url: '/assets/geared-up.png'
            }
        ]
    });
